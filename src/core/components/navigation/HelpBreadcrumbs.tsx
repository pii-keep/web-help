 ...
 * @module @piikeep-pw/web-help/components/navigation/HelpBreadcrumbs
 *
 ...
 */
export const HelpBreadcrumbs = forwardRef<HTMLElement, HelpBreadcrumbsProps>(
            ...
            return (
              ...
              >
                {renderItem
                  ...
                  : defaultRenderItem(item, isLast)}
                {!isLast && (
                  <span
                    className='help-breadcrumb-separator'
                    aria-hidden='true'
                  >
                    {separator}
                  </span>
