 ...
 * @module @piikeep-pw/web-help/components/feedback/HelpFeedback
 *
 ...
 */
export const HelpFeedback = forwardRef<HTMLDivElement, HelpFeedbackProps>(
    ...
    return (
      ...
      >
        ...
        {renderButtons ? (
          ...
          <div
            className='help-feedback-buttons'
            role='group'
          ...
          >
            ...
            >
              <span className='help-feedback-icon' aria-hidden='true'>
                👍
              </span>
