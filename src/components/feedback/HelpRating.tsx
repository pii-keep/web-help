 ...
 * @module @piikeep-pw/web-help/components/feedback/HelpRating
 *
 ...
 */
export const HelpRating = forwardRef<HTMLDivElement, HelpRatingProps>(
  function HelpRating(
    {
      value = 0,
      max = 5,
        ...
        {Array.from({ length: max }, (_, index) => {
          ...
          return (
            <button
              ...
              tabIndex={
                rating === value || (value === 0 && rating === 1) ? 0 : -1
              }
            >
