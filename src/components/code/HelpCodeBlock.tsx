 ...
 * @module @piikeep-pw/web-help/components/code/HelpCodeBlock
 *
 ...
 */
export const HelpCodeBlock = forwardRef<HTMLDivElement, HelpCodeBlockProps>(
    ...
    return (
      ...
      >
        ...
        <pre className='help-code-pre'>
          <code
            className={`help-code ${language ? `language-${language}` : ''}`}
          >
            {lineNumbers ? (
                ...
                <tbody>
                  {lines.map((line, index) => {
                    ...
                    return (
                      ...
                      >
                        <td
                          className='help-code-line-number'
                          aria-hidden='true'
                        >
                          {lineNumber}
                        </td>
