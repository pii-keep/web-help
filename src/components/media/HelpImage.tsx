 ...
 * @module @piikeep/web-help/components/media/HelpImage
 *
 ...
 */
export const HelpImage = forwardRef<HTMLElement, HelpImageProps>(
  function HelpImage(
    {
      src,
      alt,
    ...
    return (
      <>
        ...
        >
          ...
          {caption && (
            <figcaption className='help-image-caption'>{caption}</figcaption>
          )}
        </figure>
